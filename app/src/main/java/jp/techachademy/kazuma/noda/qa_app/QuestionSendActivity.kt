        ...
        if (v == imageView) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    requestPermissions(arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE), PERMISSIONS_REQUESTCODE)
                    return
                }
            } else {
                showChooser()
            ...
            val body = edit_text_content.text.toString()
            ...
            if (body.isEmpty()) {
                Snackbar.make(v, "Please enter the question", Snackbar.LENGTH_LONG).show()
                return
            }
